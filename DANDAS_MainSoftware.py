...
def DANDAS(Halo_Profile, Antiparticle_Nature,plot_preference, data,**kwargs):
    ...
    if Halo_Profile=='NFW' or Halo_Profile=='NFW Custom Quick':
        ...
        for exp in range(3):
            ...
            D_auger[i]=auger_dfactor.dfactor.mean
            J_auger[i]=auger_dfactor.jfactor.mean
            i=i+1

        stop7 = timeit.default_timer()
        print ("Time for auger calculation:", stop7 - start1)
        print(D_tambo)
   ...
   # tau_cta=rescaling(cta_mass,cta_sigmaV,J_cta,D_cta)
    ...
    if plot_preference!='No_plot':
        ...
        plt.text(1e10, 4e25, 'AUGER', fontsize=fsize,color=aug_col,clip_on=True)
        ...
        plt.text(1e10, 4e-25, 'AUGER', fontsize=fsize,color=aug_col,clip_on=True)
