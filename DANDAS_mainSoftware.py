...
def DANDAS(Halo_Profile, Antiparticle_Nature,plot_preference,data,**kwargs):
    ...
    import warnings   #This command is used so that warnings related to precision of integration are ignored (as error is negligible compared to confidence level of projected sensitivity)
